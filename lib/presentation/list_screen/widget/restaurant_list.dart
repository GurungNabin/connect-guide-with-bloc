...
class RestaurantList extends StatelessWidget {
  ...
  const RestaurantList({super.key, required this.userPosition});
...
//           child: Column(
//             children: [
//               ...business.restaurants.map((restaurant) => _buildBusinessCard(restaurant)),
//             ],
//           ),
//         );
//       },
...
// }
        ...
        return Column(
          children: [
            ...business.restaurants
                .map((restaurant) => _buildBusinessCard(restaurant)),
          ],
        );
      },
    );
  ...
  Widget _buildBusinessCard(dynamic business) {
    ...
    if (business is RestaurantEntity) {
      title = 'Restaurant';
